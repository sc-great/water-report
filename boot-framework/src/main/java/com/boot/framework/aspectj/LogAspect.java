...
import com.boot.common.enums.BusinessStatus;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.boot.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                String userOrgs="";
                List<SysOrg> sysOrgList=currentUser.getSysOrgs();
                for(SysOrg sysOrg:sysOrgList){
                    if("".equals(userOrgs)){
                        userOrgs=sysOrg.getOrgName();
                    }else{
                        userOrgs+=","+sysOrg.getOrgName();
                    }
                }
                if (StringUtils.isNotEmpty(userOrgs))
                {
                    operLog.setDeptName(userOrgs);
                }
            }
