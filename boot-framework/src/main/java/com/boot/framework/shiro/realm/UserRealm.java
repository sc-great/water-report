package com.boot.framework.shiro.realm;
...
import com.boot.common.exception.user.RoleBlockedException;
...
import com.boot.framework.shiro.service.SysLoginService;
...
public class UserRealm extends AuthorizingRealm
{
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0)
    {
        ...
        {
            List<SysRole> sysRoleList=user.getSysRoles();
            if(sysRoleList!=null){
