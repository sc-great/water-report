package com.boot.generator.util;
...
import com.boot.generator.config.GenConfig;
...
public class VelocityUtils
{
    ...
    public static VelocityContext prepareContext(GenTable genTable)
    {
        ...
        velocityContext.put("dataScope", genTable.getDataScope());
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StringUtils.format("{}/list.html", htmlPath);
        }
        else if (template.contains("list-tree.html.vm"))
        {
            fileName = StringUtils.format("{}/list-tree.html", htmlPath);
        }
